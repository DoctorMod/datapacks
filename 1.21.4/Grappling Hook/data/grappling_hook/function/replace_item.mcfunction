item modify entity @a[predicate=grappling_hook:this_id,tag=!this,nbt={SelectedItem:{"components":{"minecraft:custom_data":{grapple_hook_replace:1b}}}}] weapon.mainhand {"function":"minecraft:set_components","components":{"use_remainder":{id:"minecraft:snowball",count:1,components:{"minecraft:max_stack_size":1,"minecraft:max_damage":130,"minecraft:damage":131,"custom_model_data":{"strings":["grapplehook_thrown"]},"minecraft:item_model":"fishing_rod","minecraft:custom_data":{grapplehook:1b},"minecraft:item_name":'"Grappling Hook"',"minecraft:use_cooldown":{seconds:1,cooldown_group:"grappling_hook:grapple"},"minecraft:use_remainder":{id:"minecraft:snowball",count:1,components:{"minecraft:max_stack_size":1,"minecraft:max_damage":130,"minecraft:damage":131,"custom_model_data":{"strings":["grapplehook"]},"minecraft:item_model":"warped_fungus_on_a_stick","minecraft:custom_data":{grapplehook:1b,grapple_hook_replace:1b},"minecraft:item_name":'"Grappling Hook"'}}}}}}
